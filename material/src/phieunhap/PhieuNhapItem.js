    ...
    return (
        ...
        <View style={styles.itemphieu}>
            ...
            <View style={styles.itemfield}>
                ...
                {(phieunhap.ngay).slice(8,10)}-{(phieunhap.ngay).slice(5,7)}-{(phieunhap.ngay).slice(0,4)}
                </Text>
            </View>
            ...
            <View View style={styles.option}>
                ...
                <View><MaterialCommunityIcons name={ctpn ? "eye" : "eye-off"} size={25} color="#fff"
                    onPress={() => {
                        setCTPN(!ctpn)
                    }}
                /></View>
        ...
        {
            ctpn ? <ChiTietPhieuNhap key={phieunhap._id} phieunhap={phieunhap}
