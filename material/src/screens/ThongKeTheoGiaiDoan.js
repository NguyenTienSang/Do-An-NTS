...
export default function ThongKeTheoGiaiDoan({navigation}){
  ...
  return (
    <View style={{flex:1}}>
      ...
      <View style={{marginLeft:'auto',marginRight:'auto'}}>
            <Text style={{marginLeft:'auto',marginRight:'auto',fontSize:20,fontWeight:'500',marginBottom:30}}>Thống Kê Theo Giai Đoạn</Text>
             <Button buttonStyle={styles.buttonAction} title="Thống kê theo đại lý"
                    ...
                    <Button buttonStyle={styles.buttonAction} title="Thống kê tất cả đại lý"
                             onPress={ async () => {
                               ...
                               navigation.navigate("ThongKeTheoGiaiDoanTatCaDaiLy")
                                }
                              }
                    />
      </View>
