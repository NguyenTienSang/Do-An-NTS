                ...
                <View style={styles.listPrice}>
                    {
                        ...
                        warehouse.filter(item=>{
                            ...
                            <View key={item._id}>
                                <View style={{display:'flex',flexDirection:'column',borderWidth:1,borderColor:'#1b94ff',borderRadius:5,marginLeft:3,marginBottom:20,paddingTop:7,paddingBottom:7}}>
